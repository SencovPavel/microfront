...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BrALZ0a1.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-B-igiCQ4.js', import.meta.url).href),import:true},'mobx':{get:()=>()=>__federation_import(new URL('__federation_shared_mobx-zzOJ2BDy.js', import.meta.url).href),import:true},'mobx-react-lite':{get:()=>()=>__federation_import(new URL('__federation_shared_mobx-react-lite-C_uEgCfj.js', import.meta.url).href),import:true},'styled-components':{get:()=>()=>__federation_import(new URL('__federation_shared_styled-components-RWW8Lrwc.js', import.meta.url).href),import:true}};
