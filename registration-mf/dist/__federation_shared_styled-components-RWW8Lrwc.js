...
function ae(e2, t2) {
  ...
  for (var n2 = e2[0], o2 = 1; o2 < e2.length; o2++) n2 += t2 ? t2 + e2[o2] : e2[o2];
  return n2;
}
function ce(e2) {
...
var Me = new ke(), ze = Fe(), $e = o.createContext({ shouldForwardProp: void 0, styleSheet: Me, stylis: ze }), Be = $e.Consumer, Le = o.createContext(void 0);
function Ge() {
  return c($e);
}
function Ye(e2) {
  var t2 = s(e2.stylisPlugins), n2 = t2[0], r2 = t2[1], c2 = Ge().styleSheet, l2 = i(function() {
    var t3 = c2;
    return e2.sheet ? t3 = e2.sheet : e2.target && (t3 = t3.reconstructWithOptions({ target: e2.target }, false)), e2.disableCSSOMInjection && (t3 = t3.reconstructWithOptions({ useCSSOMInjection: false })), t3;
  }, [e2.disableCSSOMInjection, e2.sheet, e2.target, c2]), u2 = i(function() {
  ...
  return o.createElement($e.Provider, { value: d2 }, o.createElement(Le.Provider, { value: u2 }, e2.children));
}
var We = (function() {
  function e2(e3, t2) {
    var n2 = this;
...
})(), et = o.createContext(void 0), tt = et.Consumer;
function nt() {
  var e2 = c(et);
  if (!e2) throw he(18);
  return e2;
...
function ot(e2) {
  var n2 = o.useContext(et), r2 = i(function() {
...
function ft(n2) {
  ...
  var l2 = function(e2) {
    var t2 = Ge(), n3 = o.useContext(et), r3 = o.useRef(t2.styleSheet.allocateGSInstance(a2)).current;
    return t2.styleSheet.server && u2(r3, e2, t2.styleSheet, n3, t2.stylis), o.useLayoutEffect(function() {
...
function yt(e2) {
  var n2 = o.forwardRef(function(n3, r2) {
    var s2 = I(n3, o.useContext(et), e2.defaultProps);
    return o.createElement(e2, __assign({}, n3, { theme: s2, ref: r2 }));
  });
...
var vt = (function() {
  ...
  return e2.prototype.collectStyles = function(e3) {
    ...
    return o.createElement(Ye, { sheet: this.instance }, e3);
